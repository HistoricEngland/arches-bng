"""
Django settings for arches_bng project.
"""
...
SECRET_KEY = "django-insecure-#c-k9z$@x9-ci@1n0-swb&+bkjt0km45&zmke$_!=pgivan)@%"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_bng.urls"
ROOT_HOSTCONF = "arches_bng.hosts"

DEFAULT_HOST = "arches_bng"
...
ELASTICSEARCH_PREFIX = "arches_bng"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_bng.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_bng",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_bng.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_bng"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_bng.search.es_mapping_modifier.EsMappingModifier"]
